...
<head>
    ...
    <title>Pr&eacute;sentation SNK</title>
...
<body class="bg-[#04151F]">
    ...
    <div class="flex justify-center items-center w-full" >
        <div class="flex flex-col w-[650px] h-[950px] justify-center items-center bg-gradient-to-br from-amber-500 from-[-50%] backdrop-blur-[7px] rounded-[30px]">
            ...
            <div class="flex text-white text-center mx-10 text-xl mb-[-50px] font-[Roboto]">
                <p classs="flex text-white text-center ">Le monde appartient d&eacute;sormais aux Titans, des &ecirc;tres 
                    gigantesques qui ont presque d&eacute;cim&eacute; l'Humanit&eacute;. Voil&acirc; 
    ...
    <div class="flex flex-row w-full justify-center items-center h-[250px] mt-[50px] mb-[100px]">
        <div class="flex flex-row w-[49%] h-full ml-10 font-[Roboto]">
        ...
        <div class="flex flex-col w-[49%] h-full justify-around items-center ml-10 font-[Roboto]">

            <div class="flex justify-items-top flex-col-2 w-full h-[50%]">
                <div class="flex flex-col-2">
                    <div class="flex">
                        <img class="flex w-[110px] h-[75px]" src="../../Icons/user.png">
                    </div>
                    <div>
            ...
            <div class="flex flex-col w-[50%] h-full justify-around items-center">
                ...
                <div class="flex justify-items-top flex-col-2 w-full h-[50%] ml-[250px]">
                    <div class="flex flex-col-2">
                        ...
                        <div class="flex w-[70%] h-[75px]">
                            <img class="flex w-[100%] h-[75px]" src="../../Icons/user.png">
                        </div>
                    </div>
                </div>
            </div>
