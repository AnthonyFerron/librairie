        ...
        <div class="flex flex-col w-[650px] h-[710px] justify-center items-center bg-gradient-to-br from-amber-500 from-[-50%] backdrop-blur-[7px] rounded-[30px]">
            ...
            <div class="flex text-white text-center mx-10 text-xl mb-[-50px]">
                <p classs="flex text-white text-center font-[Roboto]">En 9 histoires, les in&eacute;puisables b&ecirc;tises du fr&egrave;re et de la soeur, 
                    duo infernal. Le mercredi, Tom-Tom et Nana ont du temps libre, 
                    qu'ils peuvent employer &agrave; de nouvelles gaffes. Histoires 
                    initialement parues dans le journal "J'aime lire".
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-row w-full justify-center items-center h-[250px] mt-[50px] mb-[170px]">
        <div class="flex flex-row w-[49%] h-full ml-10">
            ...
            <div class="flex flex-row justify-around items-center w-[50%] h-full mr-10">
                ...
                <div class="flex flex-col text-right text-2xl w-[50%] h-full text-white font-[Roboto]">
                    <p >
                        8€65<br>
                        <br>Jacqueline Cohen <br>
                        <br>Bayard<br>
                        <br>2004
                    </p>
                </div>
        ...
        <div class="flex flex-col w-[49%] h-full justify-around items-center mt-20 ml-10">
            ...
            <div class="flex flex-col w-[50%] h-full justify-around items-center ml-[250px] mt-10">
                ...
                <div class="flex justify-items-top flex-col-2 w-full h-[50%]">
                    <div class="flex flex-col-2">
                        ...
                        <div class="w-[60%] h-[75px]">
                            <img class="w-[100%] h-[75px]" src="../../Icons/user.png">
                        </div>
                    </div>
                </div>
            </div>
